...
// ============================================================
// FILE: Page4m.php
// PURPOSE: Admission Register — Juniors March 1954 to January 1963 - page index table linking to document images.
// PARENT PAGE: Page_4.php
// ============================================================

// LINE 1: Set browser tab title
$page_title = 'Marshfield School History - Admission Register — Juniors March 1954 to January 1963';
...
?>
    ...
    <div class="content-full">
        ...
        <div class="table-section">
            ...
            <h2>Admission Register — Juniors March 1954 to January 1963</h2>

            <!-- LINE 6: Info box -->
            <div class="info-box">
                Click any page number to view it. Images are in:
                <code>Images/Admission_Registers/Juniors_1954-1963/</code><br>
                — Add hyperlinks using the Instruction Manual.
            </div>

            <!-- LINE 7: Page index table
                 INSTRUCTION: Replace each # with the correct viewer link.
                 Format: viewer.php?file=Images/Admission_Registers/Juniors_1954-1963/Page_01.jpg&back=Page4m.php
