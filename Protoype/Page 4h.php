...
<!-- ============================================================
     FILE: Page4h.php
     PURPOSE: Admission Register (Infants) 1965 - 1971 - page index table linking to document images
...
<head>
     ...
     <title>Marshfield School History - Admission Register Infants 1965-1971</title>
    ...
    <main id="main-content">
        <div class="content-full">
            <div class="table-section">
                <h2>Admission Register (Infants) 1965 - 1971</h2>
                <div class="info-box">
                    Click any page to view it. Images are in:
                    <code>Images/Admission_Registers/Infants_1965-1971/</code>
