...
<!-- ============================================================
     FILE: Page4j.php
     PURPOSE: Admission Register (Junior) 1911 - 1917 - page index table linking to document images
...
<head>
    <!-- Character encoding for the text to be rendered properly -->
     ...
     <title>Marshfield School History - Admission Register Junior 1911-1917</title>
    ...
    <main id="main-content">
        <div class="content-full">
            <div class="table-section">
                <h2>Admission Register (Junior) 1911 - 1917</h2>
                <div class="info-box">
                    Click any page to view it. Images are in:
                    <code>Images/Admission_Registers/Junior_1911-1917/</code>
