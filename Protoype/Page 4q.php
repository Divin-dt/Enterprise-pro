...
<!-- ============================================================
     FILE: Page4q.php
     PURPOSE: Punishment Book 1903 - 1965 - page index table linking to document images
...
<head>
    ...
    <title>Marshfield School History - Punishment Book 1903-1965</title>
    ...
    <main id="main-content">
        <div class="content-full">
            <div class="table-section">
                <h2>Punishment Book 1903 - 1965</h2>
                <div class="info-box">
                    Click any page to view it. Images are in:
                    <code>Images/Punishment_Books/</code>
