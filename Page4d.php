...
// ============================================================
// FILE: Page4d.php
// PURPOSE: Logbook — Juniors 1910 to 1933 - page index table linking to document images.
// PARENT PAGE: Page_4.php
// ============================================================

// LINE 1: Set browser tab title
$page_title = 'Marshfield School History - Logbook — Juniors 1910 to 1933';
...
?>
    ...
    <div class="content-full">
        ...
        <div class="table-section">
            ...
            <h2>Logbook — Juniors 1910 to 1933</h2>

            <!-- LINE 6: Info box -->
            <div class="info-box">
                Click any page number to view it. Images are in:
                <code>Images/Log_Books/Juniors_1910-1933/</code><br>
                — Add hyperlinks using the Instruction Manual.
            </div>

            <!-- LINE 7: Page index table
                 INSTRUCTION: Replace each # with the correct viewer link.
                 Format: viewer.php?file=Images/Log_Books/Juniors_1910-1933/Page_01.jpg&back=Page4d.php
