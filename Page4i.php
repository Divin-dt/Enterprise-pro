...
<!-- ============================================================
     FILE: Page4i.php
     PURPOSE: Admission Register (Junior) 1906 – 1911 - page index table linking to document images
...
<head>
    ...
    <title>Marshfield School History - Admission Register Junior 1906-1911</title>
    ...
    <main id="main-content">
        <div class="content-full">
            <div class="table-section">
                <h2>Admission Register (Junior) 1906 – 1911</h2>
                <div class="info-box">
                    Click any page to view it. Images are in:
                    <code>Images/Admission_Registers/Junior_1906-1911/</code>
