...
<!-- ============================================================
     FILE: Page4e.php
     PURPOSE: Logbook (Junior) 1933 - 1964 - page index table linking to document images
...
<head>
    ...
    <title>Marshfield School History - Logbook Junior 1933-1964</title>
    ...
    <main id="main-content">
        <div class="content-full">
            <div class="table-section">
                <h2>Logbook (Junior) 1933 - 1964</h2>
                <div class="info-box">
                    Click any page to view it. Images are in:
                    <code>Images/Log_Books/Junior_1933-1964/</code>
